// Dev API Logger
// Usage: paste entire file content into the browser console on the webapp page, or load as a bookmarklet.
// It logs user click/scroll actions and correlates nearby fetch/XHR requests/responses to the latest action.
(function(){
  ...
  // record user actions (click, scroll)
