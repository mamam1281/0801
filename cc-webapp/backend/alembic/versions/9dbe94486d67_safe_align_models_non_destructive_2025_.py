...
def upgrade() -> None:
    ...
    # Get existing tables to avoid errors on non-existent tables
    existing_tables = set(insp.get_table_names())
    
    # Guard: create index only if missing to avoid duplicate index errors
    if 'ab_test_participants' in existing_tables:
    ...
    if 'event_participations' in existing_tables:
    ...
    if 'game_history' in existing_tables:
    ...
    # Check if user_rewards table exists before altering
