...
export function AdminPanel({ user, onBack, onUpdateUser, onAddNotification }: AdminPanelProps) {
  ...
  const quickActions: QuickAction[] = [
    ...
    // 🛡️ 보안 관리
    {
      ...
      icon: AlertTriangle,
      color: 'from-error to-error-soft',
      category: 'security',
      onClick: () => setActiveView('security')
    },
    {
  ...
  const categoryColors = {
    user: 'from-success to-info',
    shop: 'from-warning to-gold',
    security: 'from-error to-warning',
    system: 'from-secondary to-muted',
    broadcast: 'from-primary to-error'
  };
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-6">
            <div className="text-center">
              <div className="text-lg font-bold text-primary">{coreStats.onlineUsers}</div>
              <div className="text-xs text-muted-foreground">온라인</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-gold">${(coreStats.todayRevenue/1000).toFixed(0)}K</div>
              <div className="text-xs text-muted-foreground">오늘 수익</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-error">{coreStats.criticalAlerts}</div>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <Button
              ...
              className="ml-auto btn-hover-lift"
            >
        ...
        <AnimatePresence mode="wait">
          {activeView === 'menu' && (
            ...
            >
              ...
              {coreStats.criticalAlerts > 0 && (
                <Alert className="border-error bg-error-soft">
                  <AlertTriangle className="h-4 w-4" />
                  <AlertDescription className="text-foreground">
                    <strong>{coreStats.criticalAlerts}개의 긴급 알림</strong>이 있습니다. 
                    <Button variant="link" className="p-0 h-auto ml-2 text-error" onClick={() => setActiveView('security')}>
                      지금 확인하기 →
                    </Button>
                  </AlertDescription>
                </Alert>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div className={`w-8 h-8 bg-gradient-to-r ${categoryColors[category as keyof typeof categoryColors]} rounded-lg flex items-center justify-center`}>
                            ...
                            >
                              <CardContent className="p-4">
                                <div className="flex items-start gap-3">
                                  <div className={`w-12 h-12 bg-gradient-to-r ${action.color} rounded-xl flex items-center justify-center metal-shine`}>
          ...
          {activeView === 'dashboard' && (
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-xl font-bold text-foreground">📊 핵심 대시보드</h2>
                ...
                <Card className="glass-metal">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-foreground">{coreStats.totalUsers.toLocaleString()}</div>
                ...
                <Card className="glass-metal">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-foreground">{coreStats.activeUsers.toLocaleString()}</div>
                        <div className="text-sm text-muted-foreground">활성 사용자</div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="glass-metal">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-foreground">${(coreStats.totalRevenue / 1000).toFixed(0)}K</div>
                        <div className="text-sm text-muted-foreground">총 수익</div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="glass-metal">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-foreground">{coreStats.criticalAlerts}</div>
