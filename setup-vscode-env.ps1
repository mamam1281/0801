# setup-vscode-env.ps1
# VSCode 개발 환경 완전 설정 스크립트
...
# 3. VSCode 설정 파일 생성 (여기서 here-string 대신 파일 직접 작성 사용)
...
Set-Content -Path ".vscode/settings.json" -Value $settingsJsonContent -Encoding UTF8
