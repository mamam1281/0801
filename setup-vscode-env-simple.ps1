# setup-vscode-env-simple.ps1
# VSCode 개발 환경 완전 설정 스크립트 (단순화된 버전)
...
if (-not (Test-Path ".vscode/snippets")) {
    ...
    Write-Host "📁 .vscode/snippets 디렉토리 생성됨" -ForegroundColor Green
}
...
'@ | Out-File -FilePath $extensionsPath -Encoding utf8
Write-Host "✅ extensions.json 생성 완료" -ForegroundColor Green

# snippets/typescriptreact.json
$snippetsPath = ".vscode/snippets/typescriptreact.json"
@'
{
  "React Component": {
    "prefix": "rfc",
...
'@ | Out-File -FilePath $snippetsPath -Encoding utf8
...
'@ | Out-File -FilePath $launchPath -Encoding utf8
...
'@ | Out-File -FilePath $prettierPath -Encoding utf8
...
'@ | Out-File -FilePath $eslintPath -Encoding utf8
